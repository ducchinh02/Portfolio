...
const menuItems = document.querySelectorAll(".header nav .menu .menu-item");
...
menuMobileLink.forEach((link) => {
	link.addEventListener("click", () => {
		const linkActive = menuMobile.querySelector(".menu-mobile a.active");
		if (linkActive) {
...
toggleMode.addEventListener("click", () => {
	...
	toggleMode.classList.contains("active")
		? body.classList.add("active-darkmode")
		: body.classList.remove("active-darkmode");
	body.classList.contains("active-darkmode")
		? (theme = "dark")
		: (theme = "light");
...
const projects = [
	...
	},
	{
		...
		details:
			"Bootstrap + Sass were used to create this education template. This template contains the following sections: Home, About, Courses, Professor, Admin Dashboard, 404...",
		links: {
	...
	},
	{
		...
		heading: "Mellifera",
		details:
			"A honey-selling template with an eye-catching, user-friendly UI built by HTML/CSS/JS. This template contains the following sections: Home, Product, Blog",
		links: {
...
const landingInner = otherProjects[0]
	.map((prj) => {
        ...
        <div class="links d-flex justify-content-between">
            <a href="${
							links.git
						}" target="_blank" class="links-item d-inline-block"><ion-icon name="logo-github"></ion-icon></a>
            <a href="${
							links.web
						}" target="_blank" class="links-item d-inline-block"><ion-icon name="globe-outline"></ion-icon></a>
        </div>
        <div class="box-details d-flex flex-column">
